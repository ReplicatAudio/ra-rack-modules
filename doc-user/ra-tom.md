...
Classic 808-style tom made from a pitch-swept sine body with an optional harmonic brightness and a short beater tick, plus the standard drive/accent/level controls.
...
- **Bright**: harmonic brightness of the body (mixes in a 2nd harmonic).
...
- **Beater**: amount of the short beater transient at the start of the hit.
...
- **Bright / Body / Pitch drop / Pitch drop time / Decay / Beater / Drive / Level CV**: bipolar CV (±10 V = full range) added to the matching knob.
