...
struct RaCymbalModule : Module {
    ...
    static constexpr float MIN_DECAY = 0.05f;    // 50 ms
    static constexpr float MAX_DECAY = 2.0f;     // 2000 ms
...
constexpr float RaCymbalModule::RATIOS[6];

struct RaCymbalWidget : ModuleWidget {
    RaCymbalWidget(RaCymbalModule* module) {
        setModule(module);
        setPanel(createPanel(asset::plugin(pluginInstance, "res/ra-cymbal.svg")));
        ...
        addInput(createInputCentered<RaPort>(Vec(cx, 25), module, RaCymbalModule::TRIG_INPUT));

        // Pitch section (left column): 1V/Oct knob + CV, FM attn + input, aligned to grid IO rows
        addParam(createParamCentered<RaKnob>(Vec(20, 75), module, RaCymbalModule::PITCH_PARAM));
        addInput(createInputCentered<RaPort>(Vec(20, 112), module, RaCymbalModule::PITCH_CV_INPUT));
        addParam(createParamCentered<RaKnob>(Vec(20, 160), module, RaCymbalModule::FM_ATTN_PARAM));
        addInput(createInputCentered<RaPort>(Vec(20, 197), module, RaCymbalModule::FM_INPUT));
        ...
        addParam(createParamCentered<RaKnob>(Vec(57, 245), module, RaCymbalModule::BRIGHT_PARAM));
        addParam(createParamCentered<RaKnob>(Vec(93, 245), module, RaCymbalModule::DRIVE_PARAM));
        addParam(createParamCentered<RaKnob>(Vec(130, 245), module, RaCymbalModule::LEVEL_PARAM));
        addInput(createInputCentered<RaPort>(Vec(57, 282), module, RaCymbalModule::BRIGHT_CV_INPUT));
        addInput(createInputCentered<RaPort>(Vec(93, 282), module, RaCymbalModule::DRIVE_CV_INPUT));
        addInput(createInputCentered<RaPort>(Vec(130, 282), module, RaCymbalModule::LEVEL_CV_INPUT));

        addOutput(createOutputCentered<RaPort>(Vec(cx, 330), module, RaCymbalModule::AUDIO_OUTPUT));
    }
};

Model* modelRaCymbal = createModel<RaCymbalModule, RaCymbalWidget>("ra-cymbal");